...
const socialLinks = [
    ...
    {
      href: 'https://www.linkedin.com/in/mohamed-firas-130b01274/',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://www.instagram.com/firas_al.farra/profilecard/?igsh=MXJ6cTV5dGVrc3A1eQ==',
...
const Contact2 = () => {
  return (
    <section id="contact" className="section py-20 bg-zinc-950">
         <div className="container w-3/5 lg:grid lg:grid-cols-2 lg:items-stretch">
         <div className="container mx-auto px-8 md:px-16 lg:px-24">
      <h2 id="title_Contact" className="text-5xl font-bold text-center mb-12 text-transparent 
      bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">Contact</h2></div><br />
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
            
        <h2 className="headeline-2 lg:max-w-[ch] mb-10 text-4xl">
        ...
        <p className='text-xl font-bold'>I'm open to discussing web development project or partnership opportunities</p>
           ...
           <div className='mb-4 mt-8'>
                ...
                <a  href="https://www.linkedin.com/in/mohamed-firas-130b01274/" className='text-lg hover:underline'>
                linkedin.com/mohamed-firas
                </a>
            </div>
            <div className='mb-4'>
                 <div className='inline-block text-green-400 mr-2'><span class="material-symbols-outlined">
mail
                ...
                <span className='text-lg'>+963  940  319  051</span>
            </div>
            </div>
             <div className="flex items-center gap-8 mt-auto">
                {socialLinks.map(({href , icon } , key) => (
                    ...
                    target="_blank"
                     ...
                     ring-zinc-50/5 rounded-lg transtition-[background-color , color]
                     hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80 mb-12 
          ...
          <form
           ...
           method="POST" 
           className="xl:pl-10 2xl:pl-20 py-10"
           >
            <div className="md:gride md:items-center
            md:grid-cols-2 md:gap-2
            ">
                <div className="md-4">
                    <label htmlFor="name" className=" text-2xl text-bold block text-zinc-200  font-normal mb-2">FullName</label>
                    <input type="text" name="name" id="name" autoComplete="name" required placeholder="Enter your Name" className=" block outline-nonr w-ful px-3  py-3 text-sm
                      bg-zinc-800 ring-inset ring-transparent py-4 w-72 px-8 my-4 rounded-3xl
                      transition-shadow hover:ring-zinc-50/5 focus: ring sky -400px
                      focus:ring-2" />
                </div>
                <div className="md-4">
                    <label htmlFor="Email" className=" text-2xl block text-zinc-200 font-normal mb-2">Email</label>
                    <input type="text" name="Email" id="Email" autoComplete="Email" required placeholder="Enter your Email" className=" block outline-nonr w-ful px-3  py-3 text-sm
                      bg-zinc-800  ring-inset ring-transparent py-4 w-72 px-8 my-4  rounded-3xl
                      transition-shadow hover:ring-zinc-50/5 focus: ring sky -400px
                      focus:ring-2" />
                </div>
                ...
                <div className="md-4">
                    <label htmlFor="Message" className="text-2xl text-bold block text-zinc-200  font-normal mb-2">Message</label>
                    <textarea name="Message" id="Message" placeholder="Hi!" required className="text-xl w-72 px-8 text-bold block outline-nonr w-ful px-3 py-3 
                      bg-zinc-800 ring-inset ring-transparent my-4 rounded-3xl
                      transition-shadow hover:ring-zinc-50/5 focus: ring sky -400px
                      focus:ring-2 resize-y min-h-32 max-h-80"></textarea>
                </div>

                <button type="submit" className="bg-gradient-to-r rounded-3xl from-green-400 to-blue-500 text-white hidden md:inline
            transform transition-transform duration-300 hover:scale-105 px-8 py-2 rounded-full [&]:max-w-full w-full justify-center">Submit</button>
            </div>
           </form>
         </div>
    </section>
